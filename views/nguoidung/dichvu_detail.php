<div class='article-container'>
    <div class='article-content'>
        ...
        <p><strong>Ngày đăng: </strong><?php echo $service['created_at']; ?></p>
        <img src='quantri/assets/image/<?php echo $service['image_url']; ?>' alt='Image' class='img-fluid'>
        ...
        <div class='recommended'>
            ...
            <ul>
                <?php foreach ($otherServices as $otherService): ?>
                    <li><a href='index.php?action=dichvu_detail&id=<?php echo $otherService['id']; ?>'><i class='fas fa-tooth'></i><?php echo $otherService['title']; ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
